...
O sistema criado por Wang, \emph{Intelligent Mobile Robot System}(IMRS), é
...
\end{itemize}
A grande contribuição de Wang foi a utilização de redes de Petri como módulo
...
No trabalho de Wang, o nível de coordenação do IMRS é composto por um remetente
(\emph{Dispatcher}) e três coordenadores: sistema de visão, desvio de obstáculo
e controle de rastreamento, e planejamento de trajetórias. Com o modelo de
redes de Petri não é possível implementar o esquema de linguagem de
...
\item $\sigma$ especifica, para uma dada tarefa de entrada, as transições em $N$
e as subtarefas de saída que podem ser usadas na tarefa;
...
obstáculos e controle de rastreamento; A FIGURA mostra o modelo de rede de Petri
para o Remetente.
